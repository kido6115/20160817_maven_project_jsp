	...
	$("#menu-toggle").hide();
		...
		$("#menu-toggle2").click(function(e) {
			...
			$("#wrapper").toggleClass("toggled");
						...
						<p></p>
						<div id="form">
						<form action="addPSEServlet" method="post">
							<table width="697" class="CSSTableGenerator">
								<tbody>
									...
									<tr>
										...
										<td colspan="3">
											<%
												String type = request.getParameter("pkind" + i);
														if (type.equals("1")) {
															out.println("事假");
									...
									<tr>
										...
										<td colspan="3"><%=request.getParameter("total" + i)%></td>
									</tr>
									<tr>
										<td scope="row">備註：</td>
										<td colspan="3"><%=request.getParameter("ps" + i)%>
                             ...
                             <input type="hidden" name="total<%=i%>" value="<%=request.getParameter("total" + i)%>" >
...
<form    action="addPSEViewServlet" method="post" >
<% int k=0;
for (int i = 1; i <= 5; i++) {
...
<% } %><input type="hidden" name="count" value="<%=k%>" id="count" >
<input type="submit" class=" btn btn-primary " name="submit"
									id="submitr" value="返回" > 
</form>
							<p>&nbsp;</p>
